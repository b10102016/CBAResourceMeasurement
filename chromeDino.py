...
Created on 2018-06-21 by Culebra v15.3.0
                      __    __    __    __
                     /  \  /  \  /  \  /  \ 
...
class chromeDino(CulebraTestCase):
    ...
    def testSomething(self):
        ...
        _s = chromeDino.sleep
        _v = chromeDino.verbose
        while True:
#            self.vc.dump(window=-1)
            self.device.touchDip(413.33, 388.72, 0)
            self.vc.sleep(_s)
